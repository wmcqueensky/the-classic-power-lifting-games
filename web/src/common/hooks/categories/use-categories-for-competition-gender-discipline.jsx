...
const fetchCategoriesForCompetitionGenderDiscipline = async (competitionId, gender, disciplineId) => {
  try {
...
export default fetchCategoriesForCompetitionGenderDiscipline
